...
fileDir_ann = r'F:\shujuji\DOTA_split\0Annotations0\\'
fileDir_img = r'F:\shujuji\DOTA_split\0JPEGImages0\\'

# 存放包含需要的类的图片
saveDir_img = r'F:\shujuji\DOTA_split\0JPEGImages\\'
...
for files in os.walk(fileDir_ann):
    ...
    for file in files[2]:
        ...
        # 存放包含需要的类的图片对应的xml文件
        saveDir_ann = r'F:\shujuji\DOTA_split\0Annotations\\'
